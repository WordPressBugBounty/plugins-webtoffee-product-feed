...
if (!class_exists('Webtoffee_Product_Feed_Sync_Bing_Export')) {

    class Webtoffee_Product_Feed_Sync_Bing_Export extends Webtoffee_Product_Feed_Product {
        ...
        public function __construct($parent_object) {
            ...
            $this->bing_feed_keys = array(
                'shipping_cp'  => 'shipping(country:price)',
                'shipping_csp' => 'shipping(country:service:price)',                
            ); 
        }
        ...
        public function prepare_header($form_data) {
            ...
            if('txt' === $form_data['advanced_form_data']['wt_pf_file_as']){
                foreach ($export_columns as $key => $value) {
                    if(isset($this->bing_feed_keys[$value])){
                        $export_columns[$this->bing_feed_keys[$value]] = $value;   
                        unset($export_columns[$key]);
                    }
                }
            }            
        ...
        protected function generate_row_data_wc_lower($product_object) {
            ...
            if('txt' === $this->form_data['advanced_form_data']['wt_pf_file_as']){
                foreach ($export_columns as $key => $value) {
                    if(isset($this->bing_feed_keys[$value])){
                        $export_columns[$this->bing_feed_keys[$value]] = $value;   
                        unset($export_columns[$key]);
                ...
                foreach ($category_path as $category) {
                    ...
                    if ($google_category_id) {
                        ...
                        if (false === $google_category_list) {
                            $google_category_list = Webtoffee_Product_Feed_Sync_Bing::get_category_array();
        ...
        /**
         * Bing Formatted Shipping info county and price
         *
         */
        public function shipping_cp($catalog_attr, $product_attr, $export_columns, $key = '') {
            ...
            if (isset($shipping_details) && is_array($shipping_details)) {
                foreach ($shipping_details as $k => $shipping_item) {
                    ...
                    unset($shipping_item['region'], $shipping_item['zone_name'], $shipping_item['service']);                 
            ...
            return apply_filters('wt_feed_bing_product_shipping_cp', $shipping_str, $shipping_details, $this->product);
        }   
        
        /**
         * Bing Formatted Shipping info country, service and price
         *
         */
        public function shipping_csp($catalog_attr, $product_attr, $export_columns, $key = '') {
            ...
            if (isset($shipping_details) && is_array($shipping_details)) {
                foreach ($shipping_details as $k => $shipping_item) {
                    ...
                    unset($shipping_item['region'], $shipping_item['zone_name']);                 
            ...
            return apply_filters('wt_feed_bing_product_shipping_csp', $shipping_str, $shipping_details, $this->product);
        }        
