...
if (!class_exists('Webtoffee_Product_Feed_Sync_OnBuy_Export')) {

    class Webtoffee_Product_Feed_Sync_OnBuy_Export extends Webtoffee_Product_Feed_Product {

        public $parent_module = null;
        public $product;
        public $current_product_id;
        public $form_data;
        public $onbuy_feed_keys = array();

        public function __construct($parent_object) {

            $this->parent_module = $parent_object;
                        
            $this->onbuy_feed_keys = array(
        ...
        public function prepare_header() {
            ...
            foreach ($export_columns as $key => $value) {
                if(isset($this->onbuy_feed_keys[$key])){
                    $export_columns[$key] = $this->onbuy_feed_keys[$key];                    
                }
            }
        ...
        protected function generate_row_data_wc_lower($product_object) {
            ...
            foreach ($export_columns as $key => $value) {
                if (method_exists($this, $value)) {                    
                    ...
                    if(isset($this->onbuy_feed_keys[$value])){
                        $row[$this->onbuy_feed_keys[$value]] = $column_data;
                    }else{
                        $row[$key] = $column_data;
                    }
...
/**
        ...
        public function product_name($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters( 'wt_feed_onbuy_product_title', $title, $this->product );
        }        
        ...
        public function get_shipping() {
            ...
            $shipping_obj = new Webtoffee_Product_Feed_Shipping($this->product, 'onbuy', $this->form_data);
        ...
        public function category($catalog_attr, $product_attr, $export_columns) {
            ...
            $custom_onbuy_category = get_post_meta($this->current_product_id, '_wt_onbuy_product_category', true);

            if ( !$custom_onbuy_category ) {
                ...
                $onbuy_product_category = [];
                foreach ($category_path as $category) {
                    $onbuy_category_id = get_term_meta($category->term_id, 'wt_onbuy_category', true);

                    if ($onbuy_category_id) {

                        $onbuy_category_list = wp_cache_get('wt_fbfeed_onbuy_product_categories_array');

                        if (false === $onbuy_category_list) {
                            $onbuy_category_list = Webtoffee_Product_Feed_Sync_OnBuy::get_category_array();
                            wp_cache_set('wt_fbfeed_onbuy_product_categories_array', $onbuy_category_list, '', WEEK_IN_SECONDS);
                        }


                        $onbuy_category = isset($onbuy_category_list[$onbuy_category_id]) ? $onbuy_category_list[$onbuy_category_id] : '';
                        if ('' !== $onbuy_category) {
                            $onbuy_product_category[] = $onbuy_category;
                        }
                    }
                }

                $onbuy_product_category = empty($onbuy_product_category) ? '' : $onbuy_product_category[0];
            } else {

                if( is_string($custom_onbuy_category) || is_numeric($custom_onbuy_category) ){
                $onbuy_category_list = wp_cache_get('wt_fbfeed_onbuy_product_categories_array');
                ...
                $onbuy_product_category = $onbuy_category_list[$custom_onbuy_category];
                }else{
                    $onbuy_product_category = '';
                }
            }

            return apply_filters("wt_feed_{$this->parent_module->module_base}_product_onbuy_category", $onbuy_product_category, $this->product);
        }        
         ...
         * @return mixed|void
         */
        public function default_image($catalog_attr, $product_attr, $export_columns) {
            $image = '';
            if ($this->product->is_type('variation')) {
        ...
        public function Additional_images_One($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 1);
        }

        public function Additional_images_Two($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 2);
        }

        public function Additional_images_Three($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 3);
        }

        public function Additional_images_Four($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 4);
        }

        public function Additional_images_Five($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 5);
        }

        public function Additional_images_Six($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 6);
        }

        public function Additional_images_Seven($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 7);
        }

        public function Additional_images_Eight($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 8);
        }

        public function Additional_images_Nine($catalog_attr, $product_attr, $export_columns) {
            return $this->images($catalog_attr, $product_attr, $export_columns, 9);
        }

        public function Additional_images_Ten($catalog_attr, $product_attr, $export_columns) {
 ...
 /**
         ...
         * @return mixed|void
         */
        public function wt_variation_option($catalog_attr, $product_attr, $export_columns, $key_val='label', $var_id = 1) {

            $variant_attr = '';
            if($this->product->is_type('variation')){

                $variation_attrs = $this->product->get_variation_attributes();
                $var_attrs = ('label' !== $key_val ) ?  array_values($variation_attrs) : str_replace( array( 'attribute_', 'pa_' ),  array( ' ', ' ' ) , array_keys( $variation_attrs ));
        ...
        public function Variant_One_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  1);
        }
        public function Variant_One_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 1);
        }
        
        public function Variant_Two_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  2);
        }
        public function Variant_Two_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 2);
        }
        
        public function Variant_Three_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  3);
        }
        public function Variant_Three_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 3);
        }

        public function Variant_Four_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  4);
        }
        public function Variant_Four_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 4);
        }

        public function Variant_Five_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  5);
        }
        public function Variant_Five_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 5);
        }

        public function Variant_Six_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  6);
        }
        public function Variant_Six_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 6);
        }

        public function Variant_Seven_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  7);
        }
        public function Variant_Seven_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 7);
        }

        public function Variant_Eight_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  8);
        }
        public function Variant_Eight_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 8);
        }

        public function Variant_Nine_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  9);
        }
        public function Variant_Nine_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 9);
        }

        public function Variant_Ten_Name($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'label',  10);
        }
        public function Variant_Ten_Value($catalog_attr, $product_attr, $export_columns) {
            return $this->wt_variation_option($catalog_attr, $product_attr, $export_columns, 'value', 10);
        }        
        ...
        public function age_group($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $age_group) {
                $age_group = get_post_meta($this->product->get_id(), '_wt_onbuy_agegroup', true);
            }
            return apply_filters('wt_feed_onbuy_product_age_group', $age_group, $this->product);
        }
        ...
        public function material($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $material) {
                $material = get_post_meta($this->product->get_id(), '_wt_onbuy_material', true);
            }
            return apply_filters('wt_feed_product_onbuy_material', $material, $this->product);
        }
        ...
        public function pattern($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $pattern) {
                $pattern = get_post_meta($this->product->get_id(), '_wt_onbuy_pattern', true);
            }
            return apply_filters('wt_feed_product_onbuy_pattern', $pattern, $this->product);
        }
        ...
        public function unit_pricing_measure($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $unit_pricing_measure) {
                $unit_pricing_measure = get_post_meta($this->product->get_id(), '_wt_onbuy_unit_pricing_measure', true);
            }
            return apply_filters('wt_feed_product_onbuy_unit_pricing_measure', $unit_pricing_measure, $this->product);
        }
        ...
        public function unit_pricing_base_measure($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $unit_pricing_base_measure) {
                $unit_pricing_base_measure = get_post_meta($this->product->get_id(), '_wt_onbuy_unit_pricing_base_measure', true);
            }
            return apply_filters('wt_feed_product_onbuy_unit_pricing_base_measure', $unit_pricing_base_measure, $this->product);
        }
        ...
        public function energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $energy_efficiency_class) {
                $energy_efficiency_class = get_post_meta($this->product->get_id(), '_wt_onbuy_energy_efficiency_class', true);
            }
            return apply_filters('wt_feed_product_onbuy_energy_efficiency_class', $energy_efficiency_class, $this->product);
        }
        ...
        public function min_energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $min_energy_efficiency_class) {
                $min_energy_efficiency_class = get_post_meta($this->product->get_id(), '_wt_onbuy_min_energy_efficiency_class', true);
            }
            return apply_filters('wt_feed_product_onbuy_min_energy_efficiency_class', $min_energy_efficiency_class, $this->product);
        }
        ...
        public function max_energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $max_energy_efficiency_class) {
                $max_energy_efficiency_class = get_post_meta($this->product->get_id(), '_wt_onbuy_max_energy_efficiency_class', true);
            }
            return apply_filters('wt_feed_product_onbuy_max_energy_efficiency_class', $max_energy_efficiency_class, $this->product);
        }
        ...
        public function brand($catalog_attr, $product_attr, $export_columns) {
            ...
            if ( ! $custom_brand ) {
                $custom_brand = get_post_meta($this->product->get_id(), '_wt_onbuy_brand', true);
            }
            if ( !$custom_brand ) {
        ...
        public function gtin($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $custom_gtin) {
                $custom_gtin = get_post_meta($this->product->get_id(), '_wt_onbuy_gtin', true);
            }
            if(!$custom_gtin){
        ...
        public function Parent_Group($catalog_attr, $product_attr, $export_columns) {
        ...
        public function stock($catalog_attr, $product_attr, $export_columns) {
        ...
        public function get_converted_price($price, $selected_currency) {
            ...
            if( $selected_currency !== get_option('woocommerce_currency') && $price > 0 ) {
                ...
                if (!empty($woo_currencies[$selected_currency]) && !empty($currencies[$selected_currency])) {
                    $price = round( $price * $currencies[$selected_currency]['rate'], 0 );
                }               
            }
            return apply_filters('wt_feed_filter_product_converted_price', $price, $this->product, $currencies, $selected_currency);
        ...
        /**
         * OnBuy Formatted Shipping info
         *
         */
        public function shipping($catalog_attr, $product_attr, $export_columns, $key = '') {


            $shipping_details = apply_filters( 'wt_feed_onbuy_shipping_details', array(), $this->product, $this->form_data );
            ...
            if (isset($shipping_details) && is_array($shipping_details)) {
                foreach ($shipping_details as $k => $shipping_item) {
                    ...
                    //Add separator for multiple shipping method -  comma for onbuy
            ...
            if (isset($this->form_data['advanced_form_data']['wt_pf_file_as']) && 'xml' === $this->form_data['advanced_form_data']['wt_pf_file_as']) {
                return apply_filters('wt_feed_onbuy_product_shipping_xml', $shipping_details_xml, $shipping_details, $this->product);
            }


            return apply_filters('wt_feed_onbuy_product_shipping', $shipping_str, $shipping_details, $this->product);
        }
        ...
        public function custom_label_0($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $custom_label_0) {
                $custom_label_0 = get_post_meta($this->product->get_id(), '_wt_onbuy_custom_label_0', true);
            }
            return apply_filters('wt_feed_product_onbuy_custom_label_0', $custom_label_0, $this->product);
        }
        ...
        public function custom_label_1($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $custom_label_1) {
                $custom_label_1 = get_post_meta($this->product->get_id(), '_wt_onbuy_custom_label_1', true);
            }
            return apply_filters('wt_feed_product_onbuy_custom_label_1', $custom_label_1, $this->product);
        }
        ...
        public function custom_label_2($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $custom_label_2) {
                $custom_label_2 = get_post_meta($this->product->get_id(), '_wt_onbuy_custom_label_2', true);
            }
            return apply_filters('wt_feed_product_onbuy_custom_label_2', $custom_label_2, $this->product);
        }
        ...
        public function custom_label_3($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $custom_label_3) {
                $custom_label_3 = get_post_meta($this->product->get_id(), '_wt_onbuy_custom_label_3', true);
            }
            return apply_filters('wt_feed_product_onbuy_custom_label_3', $custom_label_3, $this->product);
        }
        ...
        public function custom_label_4($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $custom_label_4) {
                $custom_label_4 = get_post_meta($this->product->get_id(), '_wt_onbuy_custom_label_4', true);
            }
            return apply_filters('wt_feed_product_onbuy_custom_label_4', $custom_label_4, $this->product);
        }
        ...
        /** Get OnBuy Sale Price effective date.
         *
         * @return string
         */
