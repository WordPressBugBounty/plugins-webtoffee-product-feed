...
if (!class_exists('Webtoffee_Product_Feed_Sync_Tiktok_Export')) {

    class Webtoffee_Product_Feed_Sync_Tiktok_Export extends Webtoffee_Product_Feed_Product {
                ...
                foreach ($category_path as $category) {
                    ...
                    if ($tiktok_category_id) {
                        ...
                        if (false === $tiktok_category_list) {
                            $tiktok_category_list = Webtoffee_Product_Feed_Sync_Tiktok::get_category_array();
