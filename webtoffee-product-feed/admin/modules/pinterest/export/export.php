...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pinterest_Export')) {

    class Webtoffee_Product_Feed_Sync_Pinterest_Export extends Webtoffee_Product_Feed_Product {
                ...
                foreach ($category_path as $category) {
                    ...
                    if ($pinterest_category_id) {
                        ...
                        if (false === $pinterest_category_list) {
                            $pinterest_category_list = Webtoffee_Product_Feed_Sync_Pinterest::get_category_array();
