...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pinterest_Rss_Export')) {

    class Webtoffee_Product_Feed_Sync_Pinterest_Rss_Export extends Webtoffee_Product_Feed_Product {
        ...
        public function get_shipping() {
            ...
            $shipping_obj = new Webtoffee_Product_Feed_Basic_Shipping($this->product, 'pinterest', $this->form_data);
       ...
       /**
        ...
        public function guid($catalog_attr, $product_attr, $export_columns) {            
            ...
            return apply_filters("wt_feed_pinterest_rss_product_guid", $link, $this->product);
        }
