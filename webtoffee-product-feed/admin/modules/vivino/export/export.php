...
if (!class_exists('Webtoffee_Product_Feed_Sync_Vivino_Export')) {

    class Webtoffee_Product_Feed_Sync_Vivino_Export extends Webtoffee_Product_Feed_Product {
        ...
        public $vivino_feed_keys = array();
        public $vivino_xml_skipfeed_keys = array();
        ...
        public function prepare_header() {
            ...
            foreach ($export_columns as $key => $value) {
                if(isset($this->vivino_feed_keys[$key])){
                    $export_columns[$key] = $this->vivino_feed_keys[$key];                    
                }
            }            

            $export_columns = array_flip($export_columns); // Real feed column name of vivino to CSV header
        ...
        protected function generate_row_data_wc_lower($product_object) {
            ...
            foreach ($export_columns as $key => $value) {               
                if (method_exists($this, $value)) {                    
                    ...
                    if(isset($this->vivino_feed_keys[$value])){
                        $row[$this->vivino_feed_keys[$value]] = $column_data;
                    }else{
                        $row[$key] = $column_data;
                    }
	...
	public function isbn($catalog_attr, $product_attr, $export_columns){
        ...
        public function description($catalog_attr, $product_attr, $export_columns) {
            ...
            $description = substr($description, 0, 4900);                       
        ...
        public function get_shipping() {
            ...
            $shipping_obj = new Webtoffee_Product_Feed_Shipping($this->product, 'vivino', $this->form_data);
        ...
        public function age_group($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_vivino_product_age_group', $age_group, $this->product);
        }
        ...
        public function material($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_material', $material, $this->product);
        }
        ...
        public function pattern($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_pattern', $pattern, $this->product);
        }
        ...
        public function unit_pricing_measure($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_unit_pricing_measure', $unit_pricing_measure, $this->product);
        }
        ...
        public function unit_pricing_base_measure($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_unit_pricing_base_measure', $unit_pricing_base_measure, $this->product);
        }
        ...
        public function energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_energy_efficiency_class', $energy_efficiency_class, $this->product);
        }
        ...
        public function min_energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_min_energy_efficiency_class', $min_energy_efficiency_class, $this->product);
        }
        ...
        public function max_energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_max_energy_efficiency_class', $max_energy_efficiency_class, $this->product);
        }
        ...
        public function shipping($catalog_attr, $product_attr, $export_columns, $key = '') {
            ...
            if (isset($shipping_details) && is_array($shipping_details)) {
                foreach ($shipping_details as $k => $shipping_item) {
                    ...
                    //Add separator for multiple shipping method -  comma for vivino
            ...
            if (isset($this->form_data['advanced_form_data']['wt_pf_file_as']) && 'xml' === $this->form_data['advanced_form_data']['wt_pf_file_as']) {
                return apply_filters('wt_feed_vivino_product_shipping_xml', $shipping_details_xml, $shipping_details, $this->product);
            }


            return apply_filters('wt_feed_vivino_product_shipping', $shipping_str, $shipping_details, $this->product);
        }
        ...
        public function custom_label_0($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_custom_label_0', $custom_label_0, $this->product);
        }
        ...
        public function custom_label_1($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_custom_label_1', $custom_label_1, $this->product);
        }
        ...
        public function custom_label_2($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_custom_label_2', $custom_label_2, $this->product);
        }
        ...
        public function custom_label_3($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_custom_label_3', $custom_label_3, $this->product);
        }
        ...
        public function custom_label_4($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_vivino_custom_label_4', $custom_label_4, $this->product);
        }
        ...
        public function tax_status($catalog_attr, $product_attr, $export_columns) {
            return apply_filters('wt_feed_filter_product_tax_status', $this->product->get_tax_status(), $this->product);
                ...
                public function compute_field_mapping($value, $key, $product_object){
                ...
                if ($mode == '(+)') {                        
                        ...
                        return $this->wt_pf_product_field_calc($key, $amount, 'increase', $product_object);
                    }
                    if ($mode == '(-)') {
                        $amount = substr($compute_feed_value, 3);
                        return $this->wt_pf_product_field_calc($key, $amount, 'decrease', $product_object);
                    }
                    if ($mode == '(*)') {                        
                        $amount = substr($compute_feed_value, 3);
                        return $this->wt_pf_product_field_calc($key, $amount, 'multiply', $product_object);
                    } 
        }
