 ...
 */
if ( !class_exists( '\\Wtpf\\Banners\\Wt_Bfcm_Twenty_Twenty_Four' ) ) {
    ...
    class Wt_Bfcm_Twenty_Twenty_Four {
        ...
        public function __construct() {
            ...
            // Add banner
            add_action( 'admin_notices', array( $this, 'show_banner' ), 99 );
...
new \Wtpf\Banners\Wt_Bfcm_Twenty_Twenty_Four();
}