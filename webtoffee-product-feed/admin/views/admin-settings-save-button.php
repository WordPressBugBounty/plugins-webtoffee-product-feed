...
$settings_button_title=isset($settings_button_title) ? $settings_button_title : __( 'Update Settings', 'webtoffee-product-feed' );
...
<div class="wt-pfd-plugin-toolbar bottom">
    ...
    <div class="right">
        ...
        <input type="submit" name="wt_pf_update_admin_settings_form" value="<?php echo esc_attr($settings_button_title); ?>" class="button button-primary" style="float:right;"/>
