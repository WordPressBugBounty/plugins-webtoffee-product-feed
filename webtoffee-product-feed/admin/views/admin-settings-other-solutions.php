...
<div class="wt-pfd-tab-content" data-id="<?php echo esc_attr($target_id);?>">
    <div class="wt_row"> 
        <div clas="wt_headings">
            <h1 class="wt_heading_1"><?php _e('More Plugins To Make Your Store Stand Out', 'webtoffee-product-feed'); ?></h1>
            <h2 class="wt_heading_2"><?php _e('Check out our other plugins that are perfectly suited for WooCommerce store needs.', 'webtoffee-product-feed'); ?></h2> 
        </div>
    <div class="wt_column">
<?php 
...
$plugins=array(
    ...
    'paypal_express_checkout_plugin' => array(
        'title' => __('PayPal Express Checkout Payment Gateway for WooCommerce', 'webtoffee-product-feed'),
        'description' => __('Offer a fast checkout experience to your customers with PayPal Payment Gateway. You can set up the PayPal Express Checkout option on the product pages to reduce the clicks to complete the checkout.', 'webtoffee-product-feed'),
    ...
    'stripe_paymet_gateway_plugin' => array(
        'title' => __('WooCommerce Stripe Payment Gateway', 'webtoffee-product-feed'),
        'description' => __('Ensure a fast and secure checkout experience for your users with WooCommerce Stripe Payment Gateway. Stripe accepts credit/debit cards and offers integrations with Apple Pay, SEPA, Alipay, and more.', 'webtoffee-product-feed'),
    ...
    'subscriptions_for_woocommerce_plugin' => array(
        'title' => __('Subscriptions for WooCommerce', 'webtoffee-product-feed'),
        'description' => __('Enable subscriptions on your WooCommerce store to sell products (physical and digital) and services that require accepting recurring payments. Supports both simple and variable subscription products.', 'webtoffee-product-feed'),
            ...
            <div class="wt_widget">
                ...
                ?>
                    <div class="wt_premium_button" style="width: 100%;">
                        <a href="<?php echo esc_url($value['premium_url']); ?>" class="wt_get_premium_btn" target="_blank"><img src="<?php echo esc_url($wt_admin_img_path . '/promote_crown.png');?>" style="width: 10px;height: 10px;"><?php  _e(' Get Premium','webtoffee-product-feed'); ?></a>
                    </div> 
<?php           }   
...
?>
                    <div class="wt_installed_button">
                        <button class="wt_installed_btn">
                            <?php _e('Installed','webtoffee-product-feed'); ?>
                        </button>
                    </div>
<?php               
