...
class Webtoffee_Product_Feed_Sync_Common_Helper
{
   ...
   */
    public static function check_base_version($post_type, $post_type_title, $min_version)
    {
        ...
        {
            self::$min_version_msg.=$warn_icon.sprintf(esc_html__("The %s requires a minimum version of %s %s. Please upgrade the %s accordingly."), "<b>$post_type_title</b>", "<b>".WT_PRODUCT_FEED_PLUGIN_NAME."</b>", "<b>v$min_version</b>", "<b>".WT_PRODUCT_FEED_PLUGIN_NAME."</b>").'<br />';
